 ...
 * @sprev: pointer to previous element
 * @snext: pointer to next element
 */
...
/**
 * struct shash_table_s - struct hash table data structure
...
char *shash_table_get(const shash_table_t *ht, const char *value);
...
/**
 * shash_table_get - retrieves the value from a key
